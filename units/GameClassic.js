...
class GameClassic extends GameBase {
  ...
  async komStep() {
    ...
    this.systemMessage('Ход комиссара.')
  ...
  async mafiaStep() {
    const { periodInterval } = this

    this.systemMessage('Наступила ночь. Ход мафии.')
  ...
  async afterNight() {
    ...
    this.systemMessage('Внимание! Считаем трупы на рассвете.')
