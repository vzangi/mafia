const seoData = {
  ...
  '/competitive': {
    title: 'Описание соревновательного режима онлайн игры Мафия Уан',
    description:
  ...
  '/gift': {
    title: 'Дарите открытки друзьям и знакомым в онлайн игре Мафия Уан',
    description:
      'На этой странице вы можете выбрать одну из тысячи различных открыток разбитых для вашего удобства на категории, чтобы подарить её другу, знакомому или просто хорошему игроку.',
  },
}
